# Generated by Django 4.2.20 on 2025-04-30 17:04
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dto_ratio', models.PositiveIntegerField(blank=True, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('property_type', models.CharField(choices=[('SFH', 'Single Family Home'), ('CONDO', 'Condominium'), ('TOWNHOUSE', 'Townhouse'), ('MULTI', 'Multi-Family'), ('OTHER', 'Other')], max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('lender', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='simple_mortage.lender')),
            ],
        ),
        migrations.CreateModel(
            name='Application',
            fields=[
                ...
                ('status', models.CharField(choices=[('PENDING', 'Pending'), ('DECLINED', 'Declined'), ('APPROVED', 'Approved')], default='PENDING', max_length=20)),
                ...
                ('lender', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='applications', to='simple_mortage.lender')),
                ('property', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='applications', to='simple_mortage.property')),
            ],
        ),
    ]
